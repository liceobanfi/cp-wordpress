...
wp_nav_menu( array( 
    'theme_location' => 's-giorgio-menu', 
    'container_class' => 's-giorgio-menu-class' ) ); 
?>
		<!-- #access -->
		</nav>
...
-->
<h1 style="background-color:red;color:white;border:2px solid black;">[DEBUG] header-giorgio.php > custom header for s-giorgio pages</h1>
    </header><!-- #branding -->
