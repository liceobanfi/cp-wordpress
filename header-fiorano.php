...
wp_nav_menu( array( 
    'theme_location' => 's-fiorano-menu', 
    'container_class' => 's-fiorano-menu-class' ) ); 
?>
		<!-- #access -->
		</nav>
...
-->
<h1 style="background-color:red;color:white;border:2px solid black;">[DEBUG] header-fiorano.php > custom header for s-fiorano pages</h1>
    </header><!-- #branding -->
