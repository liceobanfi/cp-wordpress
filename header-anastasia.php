...
?>
<?php
//custom s-anastasia menu
wp_nav_menu( array( 
    'theme_location' => 's-anastasia-menu', 
    'container_class' => 's-anastasia-menu-class' ) ); 
?>
		<!-- #access -->
		</nav>
...
-->
<h1 style="background-color:red;color:white;border:2px solid black;">[DEBUG] header-anastasia.php > custom header for s-anastasia pages</h1>
    </header><!-- #branding -->
